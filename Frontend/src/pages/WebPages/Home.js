...
import OurTeam from "./../../components/HomeComponent/OurTeam";
import AllWorks from "../../components/HomeComponent/AllWorks";
import OurBlog from "../../components/HomeComponent/BlogSection";
import Testomonial from "../../components/HomeComponent/Testomonial";
import ProblemCount from "../../components/HomeComponent/ProblemCount";
import MapVisual from "../../components/HomeComponent/MapVisual";
import CallToAction from "../../components/HomeComponent/CallToAction";
import WorkStep from "../../components/HomeComponent/WorkStep";
import FAQSection from "../../components/HomeComponent/FAQ";
import ImpactStories from "../../components/HomeComponent/OurStory";
  ...
  return (
    <div className="bg-[#F4FBF7] min-h-screen flex flex-col font-poppins">
      ...
      <div className="relative min-h-[110vh] w-full">
        ...
        <div className="relative z-20 flex flex-col justify-center items-center mt-[25rem] text-white text-center px-4">
