...
const services = [
  ...
  },
  {
    ...
    desc: "We upgrade and improve street lighting across the city, ensuring safety and energy efficiency.",
    bullets: [
...
const MissionSection = () => (
  <section className="bg-[#f3f9f6] py-16 px-4 sm:px-6 lg:px-10 text-center">
    ...
    <div className="text-center mb-14">
      ...
      <p className="max-w-5xl mx-auto text-base sm:text-lg text-gray-500">
        At JanSeva Portal, our mission is to empower every citizen to actively
        participate in India’s development journey by reporting local problems,
        fostering transparency, and promoting collaboration between people and governance.
      </p>
    </div>

    {/* Services Grid */}
    <div className="grid gap-8 sm:grid-cols-3 lg:grid-cols-4 max-w-[94rem] mx-auto">
      {services.map((service, index) => (
        ...
        >
          ...
          <div className="p-6 flex flex-col flex-grow">
            <h3 className="text-lg font-bold text-[#0C2218] mb-2">{service.title}</h3>
            ...
            <button
              type="button"
              className="mt-auto border-2 border-[#FFE26A] px-4 py-2 text-[#0C2218] text-sm font-semibold hover:bg-[#0C2218] hover:text-white transition-all"
            >
              EXPLORE SERVICE
            </button>
          </div>
